...
<class_def> ::= [<scope>] class <name> (<class_rel> <main> | <main> <class_rel> | <class_rel> | <main>) <class_body>
...
<role_def>  ::= [<scope>] role <name> (<role_rel> <main> | <main> <role_rel> | <main> | <role_rel>) <role_body>
